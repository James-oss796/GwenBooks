...
export const resetPasswordEmailTemplate = (resetLink: string) => {
  const subject = "University Library: Reset Your Password";
  ...
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:#1c1c1c; padding:20px; max-width:600px; margin:auto; border:1px solid #e5e5e5; border-radius:10px; background-color:#f9f9f9;">
    <div style="text-align:center; margin-bottom:20px;">
      <img src="https://yourdomain.com/logo.png" alt="University Logo" style="width:120px;"/>
    </div>
    <h2 style="text-align:center; color:#1D4ED8;">Password Reset Request</h2>
    <p style="font-size:16px;">You requested to reset your password for your University Library account.</p>
    ...
    <p style="font-size:14px; color:#555;">University Library Team</p>
  </div>
  `;

  const text = `You requested to reset your University Library password. Use this link: ${resetLink} (Valid for 10 minutes)`;
